                    ...
                    <div className="content">
                        <div className="left">
                            <ul>
                                <li><h2>고객행복센터</h2></li>
                                <li>
                                    <a href="tel">1644-1107</a>
                                    <em>월~토요일 오전 7시 - 오후 6시</em>
                                </li>
                                <li>
                                    <button>카카오톡 문의</button>
                                    <span>월~토요일<i>|</i>오전 7시 - 오후 6시 <br />
                                ...
                                <button>대량주문 문의</button>
                                    <span>월~금요일<i>|</i>오전 9시 - 오후 6시 <br />
                                          점심시간 <i>|</i>낮 12시 - 오후 1시
                                    </span>         
                                </li>
                                <li>
                                비회원 문의 : <a href="mailto:help@kurlycorp.com">help@kurlycorp.com</a><br />
                                비회원 대량주문 문의 :  : <a href="mailto:kurlygift@kurlycorp.com">kurlygift@kurlycorp.com</a><br />
                                </li>
                            </ul>
                        </div>
                        <div className="right">
                    ...
                    <div className="content">
                            <ul>
                                <li>
                                    ...
                                    [유효기간] 2022.01.19 ~ 2025.01.18</span>
                                </li>
                                <li>
