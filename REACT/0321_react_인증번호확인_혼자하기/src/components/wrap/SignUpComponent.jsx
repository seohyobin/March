...
export default function SignUpComponent(props) {
    ...
    let 발송인증번호 = 0;
        if(regExp.test(state.휴대폰) ===false){
            ...
            num = Math.floor(Math.random()*900000+100000) //6자리의 난수 발생 -> 인증번호
            발송인증번호 = num;
            isConfirmModal=true;
...
SignUpComponent.defaultProps = {
    ...
    //6-1휴대폰인증번호 받기 버튼 disabled
    isHpdisabled:true, //휴대폰 인증번호 받기 버튼 사용 못함   
    발송인증번호:'',
