                    ...
                    <div className="gap">
                        <div className="content">
                                ...
                                <div className="container">
                                    <div className="left">
                                        <h1>
                                            ...
                                            <span><i>|</i></span>
                                            <span><Link to="">뷰티컬리</Link></span>
                                        </h1>
                                    </div>
                                    <div className="center">
                                        <div>
                                            <input type="text" name='' id='' placeholder='검색어를 입력해주세요' />
                                        <Link to="!#"><img src="./img/sign_up/searchhh.svg" alt="" /></Link> 
                                        </div>
                                    </div>
                                    <div className="right">
                                        <span><Link to="!#"><img src="./img/sign_up/map.svg" alt="" /></Link></span>
                                        <span><Link to="!#"><img src="./img/sign_up/heart.svg" alt="" /></Link></span>
                                        <span><Link to="!#"><img src="./img/sign_up/cart.svg" alt="" /></Link></span>
                                    </div>
                                </div>
                            </div>
                            <nav id='nav' className="row3">
                                <div className="container">
                                    <div className="left">
                                        <Link to="!#"><img src="./img/sign_up/ham.svg" alt="" /><span>카테고리</span></Link>
                                    </div>
                                    <div className="center">
                                        <ul>
