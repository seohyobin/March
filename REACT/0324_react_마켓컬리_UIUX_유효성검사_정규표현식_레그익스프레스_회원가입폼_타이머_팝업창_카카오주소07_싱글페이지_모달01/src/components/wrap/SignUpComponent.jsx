...
export default function SignUpComponent({회원가입, timer,timerCounterfn,주소1,주소2,addressOpenPostcode}) {
    //상위컴포넌트(wrap) 프롭스
    ...
    //상위컴포넌트 주소검색 API 함수 실행하기 -> 모달창 열기 가능
    const onClickOpenAddressApi=(e)=>{
        e.preventDefault();
        addressOpenPostcode();
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div>
                                            ...
                                            <div className="center-box">
                                              <button className={`addr-search-btn ${state.isAddress?' on' :' '}`}  
                                                type='button'
                                                onClick={onClickOpenAddressApi}
                                                >주소검색</button>
                                                <input value={주소1} type='text'className={`${state.isAddress?' on':' '}`} name='user_address1' id='userAddress1' placeholder='검색   주소1' />
                                                <input value={주소2} type='text'className={`${state.isAddress?' on':' '}`} name='user_address2' id='userAddress2' placeholder='나머지 주소2' />
                                                <h5>샛별배송</h5> 
