...
export default function SignUpComponent({회원가입, timer,timerCounterfn,mapAddressFn}) {
   ...
   // const regExp = /[^\d]/g  
    ...
    const onChangeUserService=(e)=>{     
        let 무료배송동의=[];
        if(e.target.checked){//개별체크 선택항목 value값을 이용약관배열에 축척 저장한다.
           // 무료배송동의 =state.이용약관;
        ...
        //     setState({
        //         ...state,
        //        무료배송동의:[...state.무료배송동의,e.target.value]
        //     })
        // }
            ...
            setState({
                ...
                //무료배송동의:state.무료배송동의.filter((item)=>item!==e.target.value)
            })
        }
                                            ...
                                            <div className="center-box service">
                                               ...
                                               <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        checked={state.이용약관동의.includes('무료배송, 할인쿠폰 등 혜택/정보 수신 동의(선택)', state.무료배송동의.length===2)}
